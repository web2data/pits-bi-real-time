...
public class TUbigeoProcess {
	...
	public TUbigeoProcess(BeanFactory factory, int sizePage, long dateTimeFrom,
	...
	public int startProcess() {
		TUbigeoManager tUbigeoManager = factory.getBean("tUbigeoManager",
				TUbigeoManager.class);
