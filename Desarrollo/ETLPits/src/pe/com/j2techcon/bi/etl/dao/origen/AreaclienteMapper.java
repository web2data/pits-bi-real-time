...
public interface AreaclienteMapper {
	...
	int deleteByPrimaryKey(@Param("codareacliente") String codareacliente,
	...
	Areacliente selectByPrimaryKey(
			@Param("codareacliente") String codareacliente,
			@Param("codcliente") String codcliente);

	int updateByExampleSelective(@Param("record") Areacliente record,
			@Param("example") AreaclienteExample example);

	int updateByExample(@Param("record") Areacliente record,
			@Param("example") AreaclienteExample example);
