...
create table T_AREA_CLIENTE (
   ...
   ARE_CLI_COD_TIP      INT4                 not null default 2,
...
create table T_CARGO (
   ...
   CARG_COD_EST         INT4                 not null default 37,
   FEC_NUM_CAM          INT8                 not null default 19000101010101,
   COD_IND_CAM          CHAR(1)              not null default '1',
   PROC_ID              INT4                 not null default 0,
...
create table T_CARGO_DESPACHO (
   ...
   CAR_DESP_COD_EST     INT4                 not null default 17,
   FEC_NUM_CAM          INT8                 not null default 19000101010101,
   COD_IND_CAM          CHAR(1)              not null default '1',
   PROC_ID              INT4                 not null default 0,
...
create table T_CLIENTE (
   ...
   CLI_COD_TIP          INT4                 not null default 46,
   CLI_COD_CAT          INT4                 not null default 42,
   CLI_COD_TIP_DOC      INT4                 not null default 77,
   ...
   CLI_COD_TIP_FAC      INT4                 not null default 52,
   CLI_COD_TIP_CRE      INT4                 not null default 48,
   UBI_ID               INT4                 not null default 0,
   CLI_COD              VARCHAR(20)          not null default '-',
...
create table T_COTIZACION (
   ...
   COTI_COD_AMB         INT4                 not null default 2445,
   COTI_COD_SERV        INT4                 not null default 74,
   COTI_COD_NEG         INT4                 not null default 62,
...
create table T_DESPACHO (
   ...
   ZON_ID               INT4                 not null default 0,
   EMP_CAT_ID           INT4                 not null default 0,
   DESP_COD_TIP         INT4                 not null default 86,
   DESP_COD_TIP_RUT     INT4                 not null default 90,
   DESP_COD_VER         INT4                 not null default 85,
...
create table T_EMPLEADO (
   ...
   EMP_COD_TIP_DOC      INT4                 not null default 77,
...
create table T_LIQUIDACION (
   ...
   ORD_ID               INT4                 not null default 0,
   LIQ_COD_TIP_DOC      INT4                 not null default 50,
   LIQ_COD_EST          INT4                 not null default 2449,
...
create table T_ORDEN (
   ...
   EMP_CAT_ID           INT4                 not null default 0,
   ORD_COD_TIP_REP      INT4                 not null default 115,
   SERV_ID              INT4                 not null default 0,
   PROD_ID              INT4                 not null default 0,
   ORD_COD_TIP_PAG      INT4                 not null default 107,
   ORD_COD_TIP_MON      INT4                 not null default 101,
   ORD_COD_TIP_DOC      INT4                 not null default 50,
   ORD_SERIE_DOC        VARCHAR(6)           not null default '-',
   ORD_NUM_DOC          VARCHAR(10)          not null default '-',
   ...
   ORD_COD_EST          INT4                 not null default 97,
   FEC_NUM_CAM          INT8                 not null default 19000101010101,
   COD_IND_CAM          CHAR(1)              not null default '1',
   PROC_ID              INT4                 not null default 0,
...
create table T_PRODUCTO (
   ...
   PROD_COD_TIP         INT4                 not null default 118,
   PROD_COD_AMB         INT4                 not null default 2445,
   PROD_COD_NEG         INT4                 not null default 62,
...
create table T_SEDE (
   ...
   UBI_ID               INT4                 not null default 0,
   SED_COD_TIP          INT4                 not null default 119,
...
create table T_UBIGEO (
   ...
   UBI_COD_PAIS         INT4                 not null default 386,
   UBI_COD_DEPARTAMENTO INT4                 not null default 412,
   UBI_COD_PROVINCIA    INT4                 not null default 607,
   UBI_COD_DISTRITO     INT4                 not null default 2440,
   COD_IND_CAM          CHAR(1)              not null default '1',
   FEC_NUM_CAM          INT8                 not null default 19000101010101,
   PROC_ID              INT4                 not null default 0,
