...
public class DimTipoRutaProcess {
	...
	public int startProcess()throws Exception{
		...
		while(true) {
			...
			tParametroExample.createCriteria().andFecNumCamGreaterThanOrEqualTo(dateTimeFrom).andFecNumCamLessThan(dateTimeUntil).andParamCodTipEqualTo(constantes.getParamCodeTipoRuta());
