...
public class TParametroProcess {
   ...
   public TParametroProcess(BeanFactory factory, int sizePage,
   ...
   public int startProcess(){
       TParametroManager tParametroManager = factory.getBean("tParametroManager", TParametroManager.class);
