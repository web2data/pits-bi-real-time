...
public interface DetdespachoMapper {
	...
	int updateByExampleSelective(@Param("record") Detdespacho record,
			@Param("example") DetdespachoExample example);

	int updateByExample(@Param("record") Detdespacho record,
			@Param("example") DetdespachoExample example);
