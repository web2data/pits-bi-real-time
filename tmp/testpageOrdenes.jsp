...
<script type="text/javascript">
	function modificarTabla(){
		var tabla = document.getElementById('table01');
		var celda = document.createElement('td');
		celda.appendChild(document.createTextNode('Thead cell text'));
		//tabla.tBodies[0].rows[0].cells[1].appendChild(celda);
		//tabla.tBodies[0].rows[0].cells[1].innerHTML="Medidas";
		tabla.tBodies[0].rows[0].innerHTML='<th rowspan="1" colspan="4" class="corner-heading" nowrap="nowrap">&nbsp;</th><th rowspan="1" colspan="8" align="center" class="heading-heading" nowrap="nowrap"><img src="/mondrian/jpivot/table/drill-position-other.gif" border="0" height="9" width="9">Ordenes</th><th rowspan="1" colspan="7" align="center" class="heading-heading" nowrap="nowrap"><img src="/mondrian/jpivot/table/drill-position-other.gif" border="0" height="9" width="9">Cargos</th>';
		var nuevaFila = tabla.tBodies[0].insertRow(1);
		var textoNuevaFila='<th rowspan="1" colspan="4" class="corner-heading" nowrap="nowrap">Dimensiones</th>';
		textoNuevaFila = textoNuevaFila + '<th rowspan="1" colspan="1" align="center" class="heading-heading" nowrap="nowrap"><img src="/mondrian/jpivot/table/drill-position-other.gif" border="0" height="9" width="9">Total</th>';
		textoNuevaFila = textoNuevaFila + '<th rowspan="1" colspan="2" align="center" class="heading-heading" nowrap="nowrap"><img src="/mondrian/jpivot/table/drill-position-other.gif" border="0" height="9" width="9">En fecha</th>';
		textoNuevaFila = textoNuevaFila + '<th rowspan="1" colspan="3" align="center" class="heading-heading" nowrap="nowrap"><img src="/mondrian/jpivot/table/drill-position-other.gif" border="0" height="9" width="9">Fuera de fecha</th>';
		textoNuevaFila = textoNuevaFila + '<th rowspan="1" colspan="2" align="center" class="heading-heading" nowrap="nowrap"><img src="/mondrian/jpivot/table/drill-position-other.gif" border="0" height="9" width="9">Otros</th>';
		textoNuevaFila = textoNuevaFila + '<th rowspan="1" colspan="1" align="center" class="heading-heading" nowrap="nowrap"><img src="/mondrian/jpivot/table/drill-position-other.gif" border="0" height="9" width="9">Total</th>';
		textoNuevaFila = textoNuevaFila + '<th rowspan="1" colspan="6" align="center" class="heading-heading" nowrap="nowrap"><img src="/mondrian/jpivot/table/drill-position-other.gif" border="0" height="9" width="9">Otros</th>';
		nuevaFila.innerHTML=textoNuevaFila;
		
		//var nuevaFila = tabla.tBodies[0].rows[1].cloneNode(true);
		//tabla.tBodies[0].appendChild(nuevaFila);
		
		//tBodies[0].appendChild(document.createElement('tr'));
...
<form action="testpageOrdenes.jsp" method="post">
...
<h2 align="center"><c:out value="${title01}"/></h2>
